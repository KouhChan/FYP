...
<body>
    ...
    <div class="container">
        ...
        <form action="modifyBusInfo.php" method="POST">
            ...
            <input type="text" class="form-control" value="<?php echo $busID; ?>" name="busID"><br>
            ...
            <input type="text" class="form-control" id="dateCreated" value="<?php echo $row['Date_Created']; ?> " name=" dateCreated"><br>
